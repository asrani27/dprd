...
<div class="row column_title">
   <div class="col-md-12">
      <div class="page_title">
         <h2>Hasil Laporan
            Komisi Dan Hasil Laporan Pansus</h2>
      </div>
   </div>
</div>
      ...
      <div class="heading1 margin_0">
         <form method="get" action="/superadmin/laporan/print" target="_blank">
            ...
            <select class="form-control" name="jenis" required>
               ...
               <option value="2">Laporan Rapat Komisi</option>
               <option value="3">Laporan Rapat Pansus</option>
               <option value="4">Laporan Hasil Rapat</option>
            </select>
            <br />
