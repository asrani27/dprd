         ...
         <nav id="sidebar">
            <div class="sidebar_blog_1">
               <div class="sidebar-header">
                  <div class="logo_section">
                     <a href="index.html"><img class="logo_icon img-responsive" src="/pluto/images/logo/logo_icon.png"
                           alt="#" /></a>
                  </div>
               </div>
               <div class="sidebar_user_info">
                  ...
                  <div class="user_profle_side">
                     <div class="user_img"><img class="img-responsive" src="/logo/dprd.png" alt="#" /></div>
                     <div class="user_info">
            ...
            <div class="sidebar_blog_2">
               ...
               <ul class="list-unstyled components">
                  ...
                  <li><a href="/superadmin/pimpinan"><i class="fa fa-users white_color"></i> <span>Data
                           Pimpinan</span></a></li>
                  <li><a href="/superadmin/anggota"><i class="fa fa-users white_color"></i> <span>Data Anggota
                           DPRD</span></a></li>
                  <li><a href="/superadmin/komisi"><i class="fa fa-users white_color"></i> <span>Data Komisi</span></a>
                  </li>
                  <li><a href="/superadmin/pansus"><i class="fa fa-users white_color"></i> <span>Data Pansus</span></a>
                  </li>
                  <li><a href="/superadmin/agendakomisi"><i class="fa fa-calendar white_color"></i> <span>Agenda Rapat
                           Komisi</span></a></li>
                  <li><a href="/superadmin/agendapansus"><i class="fa fa-calendar white_color"></i> <span>Agenda Rapat
                           Pansus</span></a></li>
                  <li><a href="/superadmin/hasil"><i class="fa fa-file white_color"></i> <span>Hasil Rapat</span></a>
                  </li>
                  <li><a href="/superadmin/laporan"><i class="fa fa-file white_color"></i> <span>Hasil Laporan
                           Komisi</span></a></li>
